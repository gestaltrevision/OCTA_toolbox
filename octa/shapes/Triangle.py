...
class Triangle:
    ...
    def generate(self, dwg):
        ...
        points = [(self.position[0] - self.boundingbox[0]/2 , self.position[1] + self.boundingbox[1]/2),
                  (self.position[0], self.position[1] - self.boundingbox[1]/2),
                  (self.position[0] + self.boundingbox[0]/2, self.position[1] + self.boundingbox[1]/2)]
