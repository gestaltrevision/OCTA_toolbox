...
class Text_:
    ...
    def generate(self, dwg):
        ...
        svg = dwg.text(
                ...
                text_anchor = "middle",
                insert      = (self.position[0], self.position[1]+((min(self.boundingbox))/2)-(min(self.boundingbox)*.015)),
                style = "text-align: middle; font-size:" + str(min(self.boundingbox)*1.355) + "px; font-family: Arial",
                textLength  = '100%',
