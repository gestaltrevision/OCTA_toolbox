...
#stimulus.boundingboxes = GridPattern.RepeatAcrossColumns([(30,30), (27.5, 27.5), (25,25), (22.5,22.5), (20,20), (17.5, 17.5), (15,15), (12.5,12.5), (10,10), (7.5,7.5) ])
# stimulus.boundingboxes = GridPattern.RepeatAcrossColumns(Pattern.Create2DGradient(Sequence(30, -2.5), Sequence(30, -2.5), 10))
stimulus.boundingboxes = GridPattern.RepeatAcrossColumns(Pattern.Create2DGradient(Sequence(30, -2.5), LinearGradient(11, 20, 10), 10))
stimulus.Show()

#%%
# gradient in x direction bounding box
# stimulus.boundingboxes = GridPattern.RepeatAcrossColumns([(30,30), (27.5, 30), (25,30), (22.5,30), (20,30), (17.5, 30), (15,30), (12.5,30), (10,30), (7.5,30) ])
stimulus.boundingboxes = GridPattern.RepeatAcrossColumns(Pattern.Create2DGradient(Sequence(30, -2.5), 30, 10))
stimulus.Show()

#%%
# gradient in y direction bounding box
# stimulus.boundingboxes = GridPattern.RepeatAcrossColumns([(30,30), (30, 27.5), (30,25), (30,22.5), (30,20), (30, 17.5), (30,15), (30,12.5), (30,10), (30, 7.5) ])
stimulus.boundingboxes = GridPattern.RepeatAcrossColumns(Pattern.Create2DGradient(30, Sequence(30, -2.5), 10))
stimulus.Show()
