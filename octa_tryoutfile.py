...
stimulus.shapes = GridPattern.RepeatAcrossRows([Polygon(8), Rectangle, Image("img/checkmark.svg"), Text("OCTA"), PathSvg("img/checkmark.svg"), 
...
#            stimulus.shapes[i] = type(str(stimulus.data[i][1]), (Polygon_,), {'n_sides': stimulus.data[i][0], 'name': stimulus.data[i][1]})
#        print(Polygon(stimulus.shapes[i]))
