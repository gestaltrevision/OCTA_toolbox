...
clipshape = RegularPolygon_(position = (stimsize[0]/2,stimsize[1]/2), bounding_box = (500,500), data = 8)
shapemask = FitImage_(position = (stimsize[0]/2,stimsize[1]/2), bounding_box = (500,500), data = "img/checkmark.svg")
clipshape = Path_(position = (stimsize[0]/2,stimsize[1]/2), bounding_box = (500,500), 
...
shapemask = PathSvg_(position = (stimsize[0]/2,stimsize[1]/2), bounding_box = (500,500), 
...
stimulus = Grid(10,10, background_color = "lightgrey", row_spacing = 60, col_spacing = 60, size = stimsize,
                background_shape = clipshape, mask = shapemask)
