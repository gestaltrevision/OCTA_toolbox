...
## OCTA Shiny app
A graphical user interface for OCTA is available in the form of a [Shiny app](https://elinevg.shinyapps.io/OCTA_toolbox/).</br>
In case of issues, please try this alternative link to the [Shiny app](https://octa.shinyapps.io/OCTA_app1/).
