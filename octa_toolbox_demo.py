...
stimulus.shapes      = patterns.BasicPattern([shapes.Text, shapes.Rectangle]).DuplicatePatternToSize(n_rows * n_cols)
...
stimulus.data        = patterns.BasicPattern(["hello"]).DuplicatePatternToSize(n_rows * n_cols)
stimulus.Render()
stimulus.Show()
